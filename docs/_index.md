...
{{< tab >}}
```bash
wget https://github.com/pgsty/pg_exporter/releases/download/v1.2.0/pg_exporter-v1.2.0.linux-amd64.tar.gz
tar -xf pg_exporter-v1.2.0.linux-amd64.tar.gz
sudo install pg_exporter-v1.2.0.linux-amd64/pg_exporter /usr/bin/
sudo install pg_exporter-v1.2.0.linux-amd64/pg_exporter.yml /etc/pg_exporter.yml
```
{{< /tab >}}
{{< tab >}}
```bash
